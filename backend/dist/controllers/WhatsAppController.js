...
exports.generateBroadcastLink = exports.getBroadcastLogs = void 0;
const WhatsAppBroadcastLog_1 = __importDefault(require("../models/WhatsAppBroadcastLog"));
const AuditLog_1 = __importDefault(require("../models/AuditLog"));
const zod_1 = require("zod");
const broadcastSchema = zod_1.z.object({
    type: zod_1.z.enum(["due_reminder", "meal_notice", "emergency", "custom"]),
    recipientPhone: zod_1.z.string().min(10, "Valid recipient phone number is required"),
    variables: zod_1.z.record(zod_1.z.string())
});
const getBroadcastLogs = async (req, res, next) => {
    try {
        ...
        const logs = await WhatsAppBroadcastLog_1.default.find({ houseId: req.houseId })
...
exports.getBroadcastLogs = getBroadcastLogs;
const generateBroadcastLink = async (req, res, next) => {
    try {
        const house = req.house;
        if (house.plan !== "pro") {
            return res.status(400).json({ message: "WhatsApp Broadcast is a PRO plan feature. Please upgrade your subscription." });
        ...
        const broadcastLog = await WhatsAppBroadcastLog_1.default.create({
            houseId: req.houseId,
            type,
...
exports.generateBroadcastLink = generateBroadcastLink;
